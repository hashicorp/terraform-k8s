...
import (
	v1alpha1 "github.com/hashicorp/terraform-k8s/pkg/apis/app/v1alpha1"
	"github.com/hashicorp/terraform-k8s/pkg/client/clientset/scheme"
...
// AppV1alpha1Client is used to interact with features provided by the app.terraform.io group.
type AppV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppV1alpha1Client) Workspaces(namespace string) WorkspaceInterface {
