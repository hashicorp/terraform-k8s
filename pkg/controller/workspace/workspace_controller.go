...
func (r *ReconcileWorkspace) initializeReconciliation(request reconcile.Request) (*appv1alpha1.Workspace, error) {
...
func (r *ReconcileWorkspace) reconcileWorkspace(instance *appv1alpha1.Workspace) error {
...
func (r *ReconcileWorkspace) condDeleteWorkspace(instance *appv1alpha1.Workspace) (bool, error) {
...
func (r *ReconcileWorkspace) runInProgress(instance *appv1alpha1.Workspace) (bool, error) {
...
func (r *ReconcileWorkspace) processFinishedRun(instance *appv1alpha1.Workspace) error {
...
func (r *ReconcileWorkspace) updateTerraformTemplate(instance *appv1alpha1.Workspace) (bool, error) {
...
func (r *ReconcileWorkspace) updateVariables(instance *appv1alpha1.Workspace) (bool, error) {
	workspace := fmt.Sprintf("%s-%s", instance.Namespace, instance.Name)
...
func (r *ReconcileWorkspace) startRun(instance *appv1alpha1.Workspace) error {
