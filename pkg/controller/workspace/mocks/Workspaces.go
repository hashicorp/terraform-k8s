...
func (_m *Workspaces) Delete(ctx context.Context, organization string, _a2 string) error {
	ret := _m.Called(ctx, organization, _a2)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) error); ok {
		r0 = rf(ctx, organization, _a2)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Workspaces) Update(ctx context.Context, organization string, _a2 string, options tfe.WorkspaceUpdateOptions) (*tfe.Workspace, error) {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, tfe.WorkspaceUpdateOptions) error); ok {
		r1 = rf(ctx, organization, _a2, options)
	} else {
		r1 = ret.Error(1)
	}
