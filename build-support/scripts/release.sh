...
Description:
   ...
   This script will do a full release build of terraform-k8s. Building each component
   is done within a docker container. In addition to building Terraform this
